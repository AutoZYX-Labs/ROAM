...
中国智能网联汽车产业创新联盟（CAICV，联盟秘书处提供标准化流程支持，本立项拟列入联盟工业和信息化部百项团标计划）

### 联合牵头单位（3 家）

| 单位 | 角色 | 备注 |
|---|---|---|
| 吉林大学 | 学术中立 + ROAM 框架源头 | 项目负责人：张玉新副教授 |
| 一汽集团 | 大型 OEM 代表 | L4 转型实践 |
...
起草组合计 11 家（含 1 家提出 + 3 家联合牵头 + 7 家参与）。覆盖产学研用四个维度，满足 CSAE 评审"至少 5 家起草单位"要求并显著超出。

联合牵头三家组合的战略价值：吉林大学（学术中立性 + ROAM 开源框架源头）+ 一汽集团（大型 OEM 标杆）+ 卓驭科技（智能驾驶技术创新代表），形成"高校 + 大型 OEM + 技术 OEM"三足鼎立结构。CAICV 作为提出单位，借助联盟标准化流程经验和工业和信息化部百项团标渠道，加速立项节奏。
...
| 国标转化预备 | 2026-09 起同步 | 多路径并行：TC114/SC34 GB/T、交通部 ITS、工信部百项团标 |
| 国际标准提案 | 2027-Q1 | SAE / ISO TC22 / IEEE / ITU-T 多渠道 NWIP |
