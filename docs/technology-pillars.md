...
- **GB/T 43267-2023** 《道路车辆 预期功能安全》（中国 SOTIF 国标，对应 ISO 21448）
...
- **YD/T 3977-2021** 《增强的 V2X 业务应用层交互数据要求》（V2X 应用层标准）
